 ...
 * Ë«±¶×Óµ¯½µÂäÉ¡
 */
public class Enemy5 extends Art {
	public Enemy5() {
		super();
	...
	class NormalState extends ArtState {
		...
		void reset() {
			...
			Sprite s = gameContext.getSprite("enemy5_fly_1.png");
			Rect r = s.textureRect;
			
			int random = (int) (Math.random()*(gameContext.VWidth() - r.width()-10) + 20);
			int left = gameContext.VLeft() + random;
			int top = gameContext.VTop() - r.height();//art.gameContext.VTop() - r.height();
	...
	class BombingState extends ArtState {
		...
		String nextTickSprite() {
			...
			return sprite==null ? "enemy5_fly_1.png" : null;
		}
	}
}
